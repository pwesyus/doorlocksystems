<?php
	...
	$Write="<?php $" . "Timestamp=''; " . "echo $" . "Timestamp;" . " ?>";
	file_put_contents('Timestamp.php',$Write);

	$Write="<?php $" . "Timestamp=''; " . "echo $" . "Timestamp;" . " ?>";
	file_put_contents('timein.php',$Write);
?>
...
<html>
	<head>
		...
		<script>
			...
			$(document).ready(function(){
				 $("#getTime").load("timestamp.php");
				setInterval(function() {
					$("#getTime").load("timestamp.php");	
				}, 500);
			});
			$(document).ready(function(){
				 $("#getTimein").load("timein.php");
				setInterval(function() {
					$("#getTimein").load("timein.php");	
				}, 500);
			});
		...
		<title>Read Tag : ScanGuard</title>
	</head>
	
	<body>
		<h2 align="center">ScanGuard: Door Management System</h2>
		<ul class="topnav">
					...
					<tr>
						<td  bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr>
									<td align="left" class="lf">Time</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr>
