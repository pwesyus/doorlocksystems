    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            $mail->setFrom('developer.doorlock@gmail.com', 'Password Reset');
            ...
            <h3>You're Changing your password</h3>
            ";
            ...
            if(!$mail->send()){
                ...
                ?>
                    <script>
                        window.location.replace("reset_psw1.php");
                    </script>
                <?php
            }
        }
...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#">Recover User Password</a>
